      ...
      <main className="flex-1 py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-text">Choose how you'd like to use Gran-assist</p>
          </div>
            ...
            <Link href="/profile/grandparent" className="group">
              <Card className="border-2 border-border hover:border-primary transition-all h-full cursor-pointer hover:shadow-lg">
                <CardContent className="pt-12 pb-12 text-center">
                  ...
                  <p className="text-lg text-muted-text leading-relaxed">Post simple requests for help with daily tasks.</p>
                </CardContent>
              </Card>
            </Link>

            <Link href="/profile/helper" className="group">
              <Card className="border-2 border-border hover:border-secondary transition-all h-full cursor-pointer hover:shadow-lg">
                <CardContent className="pt-12 pb-12 text-center">
                  ...
                  <p className="text-lg text-muted-text leading-relaxed">Build your profile and browse nearby requests.</p>
                </CardContent>
              </Card>
            </Link>
          </div>
